<?php
  ...
  echo sprintf('
    <div class="list-group">
      <a class="list-group-item active" style="background-color: #474747!important; color: #ffffff; border: none !important;">도서 등록</a>
      <div class="list-group-item">
          <form action="../../Action/ManagerService/RegisterBookAction.php" enctype="multipart/form-data" method="post">
